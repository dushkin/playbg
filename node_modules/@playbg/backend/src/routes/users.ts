...
// @access  Private
router.get('/leaderboard', async (req: AuthenticatedRequest, res: Response): Promise<void> => {
  try {
...
// @access  Private
router.get('/statistics/global', async (req: AuthenticatedRequest, res: Response): Promise<void> => {
  try {
...
// @access  Private
router.get('/games/recent', async (req: AuthenticatedRequest, res: Response): Promise<void> => {
  try {
    const page = parseInt(req.query.page as string) || 1;
...
// @access  Private
router.get('/:id/statistics', async (req: AuthenticatedRequest, res: Response): Promise<void> => {
  try {
