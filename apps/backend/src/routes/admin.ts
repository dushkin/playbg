...
router.get('/cache/health', async (req: AuthenticatedRequest, res: Response): Promise<void> => {
  try {
...
// @access  Private (Admin)
router.post('/cache/warm', async (req: AuthenticatedRequest, res: Response): Promise<void> => {
  try {
    const { type } = req.body;
...
// @access  Private (Admin)
router.delete('/cache/invalidate', async (req: AuthenticatedRequest, res: Response): Promise<void> => {
  try {
...
// @access  Private (Admin)
router.post('/cache/invalidate/event', async (req: AuthenticatedRequest, res: Response): Promise<void> => {
  try {
...
// @access  Private (Admin)
router.get('/cache/stats', async (req: AuthenticatedRequest, res: Response): Promise<void> => {
  try {
...
// @access  Private (Admin)
router.get('/statistics/overview', async (req: AuthenticatedRequest, res: Response): Promise<void> => {
  try {
...
// @access  Private (Admin)
router.post('/cache/rebuild', async (req: AuthenticatedRequest, res: Response): Promise<void> => {
  try {
