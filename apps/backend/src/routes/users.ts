...
// @access  Private
router.get('/profile', async (req: express.Request, res: Response): Promise<void> => {
  try {
...
// @access  Private
router.put('/profile', async (req: express.Request, res: Response): Promise<void> => {
  try {
...
// @access  Private
router.get('/leaderboard', async (req: express.Request, res: Response): Promise<void> => {
  try {
...
// @access  Private
router.get('/statistics', async (req: express.Request, res: Response): Promise<void> => {
  try {
...
// @access  Private
router.get('/statistics/global', async (req: express.Request, res: Response): Promise<void> => {
  try {
...
// @access  Private
router.get('/games/recent', async (req: express.Request, res: Response): Promise<void> => {
  try {
    const page = parseInt(req.query.page as string) || 1;
...
// @access  Private
router.get('/analytics/performance', async (req: express.Request, res: Response): Promise<void> => {
  try {
...
// @access  Private
router.get('/:id/statistics', async (req: express.Request, res: Response): Promise<void> => {
  try {
